		...
		<div className="about__container">
			<div className="about__container__text">
				...
				<p className="about__container__text__description">
					...
					leadership position, while at the second company, I led and shepherded
					the company&apos;s front end using JavaScript and React. One of my
					main accomplishments during that time was my ability to switch roles
					to work with environments that utilized Ruby on Rail, Ruby, TypeScript
					and Next.js, which sharpened my skills in these technologies.
				</p>
				<button
					type="button"
