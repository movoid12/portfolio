		...
		<div className="contact-container">
			...
			<div>
				<form className="contact-form" onSubmit={handleSubmit}>
					<label
						className="contact-form__label contact-form__subject"
						htmlFor="subject"
					>
						Subject
						<input
					...
					<label
						className="contact-form__label contact-form__name"
						htmlFor="name"
					>
						Your name
						<input
					...
					<label
						className="contact-form__label contact-form__email"
						htmlFor="email"
					>
						Your e-mail
						<input
					...
					<label
						className="contact-form__label contact-form__textarea"
						htmlFor="message"
					>
						Your message
						<textarea
					...
					<button
						className="contact-from__submit"
						type="submit"
